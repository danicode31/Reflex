...
TECNOLOGIAS_NEORIS = ['Teradata','SQL Server 2019','SSIS','Python','Jira','Control-M','MS Excel']
TECNOLOGIAS_CDA = ['Teradata','POWER BI Cloud','SSMS','Report Builder','Trello','Control-M','MS Excel']
...
LINKEDIN = 'https://www.linkedin.com/in/daniel-taboada/'
INSTAGRAM = 'https://www.instagram.com/danieltaboadaok/'
